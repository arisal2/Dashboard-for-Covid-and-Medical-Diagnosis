...
Rails.application.configure do
  ...
  # Can be used together with config.force_ssl for Strict-Transport-Security and target HTTP.
  ...
  # Set log level (info in production typically)
  ...
  # config.active_job.queue_name_prefix = "fluffy_octo_system_production"
